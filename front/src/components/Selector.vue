<template>
    <section id="selector">
        ...
        <div class="socials__wrap">
            <ul v-if="dropdown" class="socials__list">
                <li v-for="item in socials" :key="item.value" class="social__network" >
...
export default {
    ...
    computed: {
        arrow() {
           let arrow = !this.dropdown ? 'fa fa-chevron-down' : ' fa fa-chevron-up';
           return arrow
        }
    },
    methods: {
